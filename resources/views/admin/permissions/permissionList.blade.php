                                    ...
                                    <table class="table responsive nowrap" id="data_Table"  width="100%">
                                        <thead>
                                            <tr class="bg-light">
                                                ...
                                                <td width="30%">Name</td>
                                                <td width="30">Guard Name</td>
                                                <td width="27">Group Name</td>
                                            ...
                                            <tr >
                                                ...
                                                <td style="width: 12%;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" style="border: 1px solid gray;" permission="menu">
                                                        @if(Auth::guard('web')->user()->can('rolePermission.edit'))
                                                            <li type="button" class="btn " onclick="editProduct({{$permission->id}})"><i class="fa fa-edit"></i>Edit</li>
                                                        @endif
                                                        @if(Auth::guard('web')->user()->can('rolePermission.delete'))
                                                            <li class="action"><a href="{{route('permissionDelete',$permission->id)}}" class="btn"  onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash"></i> Delete </a></li>
                                                        @endif
                                                        </ul>
                                                    </div>
                                                </td>
