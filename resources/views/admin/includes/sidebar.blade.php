            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
					 ...
					 @if(Auth::guard('web')->user()->can('banner.view'))
					 <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="banner" data-parent="#accordionExample">
                            <li>
								<a  href="{{route('bannerView')}}">Banner</a>
                            </li>
                        </ul>
                    </li>
 					@endif
                     ...
                     <li class="menu">
                        <a href="#rolesPermission" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled" id="rolesPermission" data-parent="#accordionExample">
                            <li>
                                <a  href="{{route('rolesList')}}">Roles</a>
                            </li>
                            <li>
                                <a  href="{{route('permissionList')}}">Permissions</a>
                            </li>
                            <li>
                                <a  href="{{route('permissionToRoleList')}}">Give roles to permission</a>
                            </li>
